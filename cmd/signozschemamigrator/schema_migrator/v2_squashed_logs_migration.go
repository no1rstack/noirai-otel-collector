			...
			UpItems: []Operation{
				CreateTableOperation{
					...
					Indexes: []Index{
						...
						{Name: "body_index_v2_token", Expression: "lower(body)", Type: "tokenbf_v1(10000, 2, 0)", Granularity: 1},
						{Name: "body_index_v2_ngram", Expression: "lower(body)", Type: "ngrambf_v1(4, 15000, 3, 0)", Granularity: 1},
