...
import (
	...
	schema_migrator "github.com/no1rstack/noirai-otel-collector/cmd/noiraischemamigrator/schema_migrator"
...
func main() {
	cmd := &cobra.Command{
		Use:   "noirai-schema-migrator",
		Short: "NoirAI Schema Migrator",
