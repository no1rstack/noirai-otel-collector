...
import (
	...
	"github.com/no1rstack/noirai-otel-collector/processor/noirailogspipelineprocessor/internal/metadata"
...
func TestTraceProcessor(t *testing.T) {
  ...
  `
	...
	// See https://github.com/no1rstack/noirai/issues/3859 for an example
...
// Test that translated NoirAI logs pipelines work as expected
func TestNoirAILogPipelineWithRouterOp(t *testing.T) {
	confYaml := `
  operators:
      - default: noop
        id: router_noirai
