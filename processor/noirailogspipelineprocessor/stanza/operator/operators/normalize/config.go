...
func (c Config) Build(set component.TelemetrySettings) (operator.Operator, error) {
	...
	logsProcessed, err := set.MeterProvider.Meter("github.com/no1rstack/noirai-otel-collector/processor/noirailogspipelineprocessor/stanza/operator/operators/normalize").Int64Counter(
